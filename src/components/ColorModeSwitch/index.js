...
const ColorModeSwitch = () => {
  ...
  const dayBtn = React.useRef();
  const nightBtn = React.useRef();
  ...
  const star5 = React.useRef();
  const star6 = React.useRef();

  React.useEffect(() => {
    if (colorMode === "dark") dayClick();
    else nightClick();
  }, []);

  const dayClick = () => {
    sun.current.style.transform = "translateX(-157px)";
    sun.current.style.opacity = 0;

    cloud.current.style.opacity = 0;

    moon.current.style.transform = "translateX(-157px)";
    moon.current.style.opacity = 1;

    star1.current.classList.remove("off");
    star2.current.classList.remove("off");
    star3.current.classList.remove("off");
    star4.current.classList.remove("off");
    star5.current.classList.remove("off");
    star6.current.classList.remove("off");

    nightBtn.current.style.backgroundColor = "#224f6d";
    nightBtn.current.style.borderColor = "#cad4d8";
  ...
  const nightClick = () => {
    sun.current.style.transform = "translateX(15px)";
    sun.current.style.opacity = 1;

    cloud.current.style.opacity = 1;

    moon.current.style.transform = "translateX(35px)";
    moon.current.style.opacity = 0;

    star1.current.classList.add("off");
    star2.current.classList.add("off");
    star3.current.classList.add("off");
    star4.current.classList.add("off");
    star5.current.classList.add("off");
    star6.current.classList.add("off");

    nightBtn.current.style.backgroundColor = "#9cd6ef";
    nightBtn.current.style.borderColor = "#65c0e7";
  ...
  return (
    ...
    >
      <div id="day" onClick={dayClick} ref={dayBtn}></div>
      <div id="night" onClick={nightClick} ref={nightBtn}></div>
      <svg
        version="1.1"
        id="darkmode"
